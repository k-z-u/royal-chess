...
await page.evaluate(() => [...document.querySelectorAll('button')].find(b => b.title === '設定')?.click())
await page.waitForTimeout(600)
await page.screenshot({ path: '/tmp/royal-chess-shots/z5-settings.png' })
await page.keyboard.press('Escape')
await page.waitForTimeout(300)
await page.evaluate(() => [...document.querySelectorAll('button')].find(b => b.title === '新しい対局')?.click())
await page.waitForTimeout(600)
